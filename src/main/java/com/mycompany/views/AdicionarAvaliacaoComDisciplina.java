 ...
 * @author leog4
 */
public class AdicionarAvaliacaoComDisciplina extends javax.swing.JDialog {

    private Avaliacao avaliacao = null;
    private JPanel jPanel;
    
    public AdicionarAvaliacaoComDisciplina(JDialog dialog, JPanel jPanel) {
        super(dialog, true);
        this.jPanel = jPanel;
        initComponents();
    }
    ...
    private void botaoAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAdicionarActionPerformed
        ...
        avaliacao = new Avaliacao(jTextFieldNomeAvaliacao.getText(), dataUtilAvaliacao, nota);
        AdicionarDisciplina.adicionarAvaliacao(avaliacao);
        dispose();
    }//GEN-LAST:event_botaoAdicionarActionPerformed

    public Avaliacao getAvaliacaoCriada(){
        return avaliacao;
    }
